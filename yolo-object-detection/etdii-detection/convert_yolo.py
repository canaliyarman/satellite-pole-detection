# from ultralytics.data.converter import convert_dota_to_yolo

# convert_dota_to_yolo('./ETDII_YOLO/')
...
textDir = "./ETDII_YOLO/labels/val_original"
imageDir = "./ETDII_YOLO/images/val"
    ...
    for imageFile, textFile in zip(imagesFiles, textFiles):
        ...
        if imageFile.endswith(".png") and textFile.endswith(".txt"):
            ...
            if imageFile[:-4] == textFile[:-4]:
                ...
                finalFile = open(f"./ETDII_YOLO/labels/val/{textFile[:-4]}.txt", "a")
                for coordinates in coordinatesList:
                    ...
                    # finalFile = open(f"./ETDII_YOLO/labels/train/{textFile[:-4]}.txt", "a")
                    finalFile.write(out)
